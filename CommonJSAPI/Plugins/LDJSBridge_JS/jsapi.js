...
function(e) {	
    ...
    function k(e, n, i, s) {
		...
		if (C(e, n)) {
			//将传进来的所有参数生成一个url字符串；
            o = "jsbridge://" + encodeURIComponent(e) + "/" + encodeURIComponent(n),
...
mapp.build("mapp.ui.openUrl", {
    ...
    android: function(e) {
		mapp.invoke("nav", "openLinkInNewWebView", e.url);
	},
    support: {
        iOS: "1.0",
        android: "1.0"
...
mapp.build("mapp.ui.openView", {
	iOS: function(t) {
		typeof t.onclose == "function" && (t.onclose = mapp.callback(t.onclose)),
		mapp.invoke("nav", "openViewController", t)
	},
	android: function(e) {
		typeof e.onclose == "function" && (e.onclose = mapp.callback(e.onclose)),
		mapp.invoke("nav", "openView", e)
	},
	support: {
		iOS: "1.0",
		android: "1.0"
