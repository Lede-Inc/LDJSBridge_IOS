...
- (void)getDeviceInfo:(LDJSInvokedUrlCommand *)command
{
    ...
    LDJSPluginResult *pluginResult = [LDJSPluginResult
...
- (void)getClientInfo:(LDJSInvokedUrlCommand *)command
{
    ...
    LDJSPluginResult *pluginResult =
        [LDJSPluginResult resultWithStatus:LDJSCommandStatus_OK messageAsDictionary:clientInfos];
    [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
}
...
- (void)getNetworkInfo:(LDJSInvokedUrlCommand *)command
{
    ...
    LDJSPluginResult *pluginResult =
        [LDJSPluginResult resultWithStatus:LDJSCommandStatus_OK messageAsInt:netType];
    [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
}
...
- (void)setScreenStatus:(LDJSInvokedUrlCommand *)command
{
    ...
    LDJSPluginResult *pluginResult =
        [LDJSPluginResult resultWithStatus:LDJSCommandStatus_OK
